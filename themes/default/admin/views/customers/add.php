            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group person">
                        ...
                        <?php echo form_input('last_name', '', 'class="form-control tip" id="last_name" required="required" data-bv-notempty="true"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                    ...
                    <div class="form-group">
                        <?= lang("dob", "dob"); ?>
                        <?php echo form_input('dob', '', 'class="form-control input-tip date" id="dob" required="required"'); ?>
                    </div>
                    <!--<div class="form-group company">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        echo form_dropdown('marketing_officer', $mo, '', 'class="form-control select" id="marketing_officer" style="width:100%;"');
                        ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('cf2', '', 'class="form-control input-tip date" id="cf2"'); ?>


                    </div>
                    <div class="form-group">
                        <?= lang("document_expire_date", "document_expire_date"); ?>
                        <?php echo form_input('cf3', '', 'class="form-control input-tip date" id="cf3"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("ccf4", "cf4"); ?>
