            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" style="margin-bottom:0;">
                    ...
                    <tr>
                        ...
                        <td><?= $customer->last_name; ?></strong></td>
                    </tr>
                    <tr>
                    ...
                    <?php if(isset($marketing_officer)) { ?>
                    <tr>
                        <td><strong><?= lang("marketing_officer"); ?></strong></td>
                        <td><?= $marketing_officer->first_name.' '.$marketing_officer->last_name  ; ?></strong></td>
                    </tr>
                    <?php } ?>
                    <tr>
                        <td><strong><?= lang("document_number"); ?></strong></td>
                        <td><?= $customer->cf1; ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("document_issue_date"); ?></strong></td>
                        <td><?= $customer->cf2; ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("document_expire_date"); ?></strong></td>
