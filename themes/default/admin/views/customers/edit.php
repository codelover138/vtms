            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group person">
                        <?= lang("first_name", "first_name"); ?><b>*</b>
                        <?php echo form_input('name', $customer->name, 'class="form-control tip" id="name" required="required"'); ?>
                    </div>
                    <div class="form-group person">
                        <?= lang("last_name", "last_name"); ?>
                        <?php echo form_input('last_name', $customer->last_name, 'class="form-control tip" id="last_name" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                        <?php echo form_input('vat_no', $customer->vat_no, 'class="form-control" id="vat_no" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("dob", "dob"); ?>
                        <?php echo form_input('dob', $customer->gst_no, 'class="form-control input-tip date" id="dob" required="required"'); ?>
                    </div>
                    <!--<div class="form-group company">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="control-label"
                            for="marketing_officer"><?php echo $this->lang->line("marketing_officer"); ?></label>
                        <?php
                        $mo[''] = lang('select').' '.lang('marketing_officer');
                        foreach ($marketing_office as $marketing_officer) {
                            $mo[$marketing_officer->id] = $marketing_officer->first_name. ' '.$marketing_officer->last_name;
                        }
                        echo form_dropdown('marketing_officer', $mo, $customer->marketing_officer, 'class="form-control select" id="marketing_officer" style="width:100%;"');
                        ?>
                    </div>
                    <div class="form-group">
                        ...
                        <?php
                                                                                ...
                                                                                echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $customer->warehouse_id), 'id="warehouse" class="form-control select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" style="width:100%;" ');
                                                                                ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <?= lang("document_issue_date", "document_issue_date"); ?>
                        <?php echo form_input('cf2', $customer->cf2, 'class="form-control input-tip date" id="cf2"'); ?>

                    </div>
                    <div class="form-group">
                        <?= lang("document_expire_date", "document_expire_date"); ?>
                        <?php echo form_input('cf3', $customer->cf3, 'class="form-control input-tip date" id="cf3"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("ccf4", "cf4"); ?>
