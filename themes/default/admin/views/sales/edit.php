                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="document" type="file" data-browse-label="<?= lang('browse'); ?>" name="document[]" multiple data-show-upload="false"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php $sst = array('' => lang('Select_Sale_Status'),'completed' => lang('completed'),'Hold' => lang('hold'),'Work in progress' => lang('work_in_progress'), 'pending' => lang('pending'));
                        ...
                        <?php if(isset($assign_provider)){ ?>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <?= lang('assign_service_provider', 'assign_service_provider'); ?>
                                    <?php
                                    $mo[''] = lang('select').' '.lang('assign_service_provider');
                                    foreach ($assign_provider as $provider) {
                                        $mo[$provider->id] = $provider->first_name. ' '.$provider->last_name;
                                    }
                                    echo form_dropdown('assign_service_provider', $mo, $inv->service_provider, 'class="form-control select" id="assign_service_provider" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php }?>
                        <?php if(isset($assign_marketing_officer)){ ?>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <?= lang('assign_marketing_officers', 'assign_marketing_officers'); ?>
                                    <?php
                                    $mof[''] = lang('select').' '.lang('assign_marketing_officers');
                                    foreach ($assign_marketing_officer as $officer) {
                                        $mof[$officer->id] = $officer->first_name. ' '.$officer->last_name;
                                    }
                                    echo form_dropdown('assign_marketing_officers', $mo, $inv->assign_marketing_officers, 'class="form-control select" id="assign_marketing_officers" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php }?>
