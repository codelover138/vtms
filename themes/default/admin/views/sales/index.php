...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": pay_status}, {"bSortable": false,"mRender": attachment_multiple}, {"bVisible": false}, {"bSortable": false}],
            ...
            {column_number: 3, filter_default_label: "[<?=lang('Tax_Code');?>]", filter_type: "text", data: []},
