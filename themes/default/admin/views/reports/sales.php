    ...
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var gtotal = 0, paid = 0,pmo=0,pmm=0, balance = 0;
                for (var i = 0; i < aaData.length; i++) {
                    gtotal += parseFloat(aaData[aiDisplay[i]][5]);
                    paid += parseFloat(aaData[aiDisplay[i]][6]);
                    balance += parseFloat(aaData[aiDisplay[i]][7]);
                    pmo += parseFloat(aaData[aiDisplay[i]][8]);
                    pmm += parseFloat(aaData[aiDisplay[i]][9]);
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[5].innerHTML = currencyFormat(parseFloat(gtotal));
                nCells[6].innerHTML = currencyFormat(parseFloat(paid));
                nCells[7].innerHTML = currencyFormat(parseFloat(balance));
                nCells[8].innerHTML = currencyFormat(parseFloat(pmo));
                nCells[9].innerHTML = currencyFormat(parseFloat(pmm));
            }
                ...
                <div class="table-responsive">
                    <table id="SlRData"
                        ...
                        <tr>
                            ...
                            <th><?= lang("paid"); ?></th>
                            <th><?= lang("balance"); ?></th>
                            <th><?= lang("profit_share"); ?></th>
                            <th><?= lang("profit_share_marketing"); ?></th>
