    ...
    oTable = $('#TOData').dataTable({
        ...
        "fnFooterCallback": function(nRow, aaData, iStart, iEnd, aiDisplay) {
            ...
            for (var i = 0; i < aaData.length; i++) {
                row_total += parseFloat(aaData[aiDisplay[i]][8]);
        ...
        {
            column_number: 4,
            filter_default_label: "[<?=lang('Sales_Start_Date');?> (yyyy-mm-dd)]",
            filter_type: "text",
            data: []
        },
        {
            column_number: 5,
            filter_default_label: "[<?=lang('Sales_End_Date');?> (yyyy-mm-dd)]",
            filter_type: "text",
            data: []
        },
    ], "footer");
                    ...
                    <table id="TOData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                            <tr class="active">
                                ...
                                <th><?= lang("date"); ?></th>
                                <th><?= lang("customer") ; ?></th>
                                <th><?= lang("Sales_Start_Date"); ?></th>
                                <th><?= lang("Sales_End_Date"); ?></th>
                                <th><?= lang("Total_Sales"); ?></th>
                                <th><?= lang("Total_Taxes"); ?></th>
                                <th><?= lang("Total_Count"); ?></th>
